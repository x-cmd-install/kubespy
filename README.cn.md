...
[![x-cmd/install — kubespy Code Quality Monitoring Repo Card](https://repo.x-cmd.io/kubespy.svg?lang=zh)](https://x-cmd.com/install/kubespy)
...
- **发布数**: 8 · **已合并 PR**: 195 · **开放 PR**: 1 · **已关闭 issue**: 41 · **开放 issue**: 13 · **提交数**: 224
...
_数据快照: `data/card/260922.yml` · 2026-09-22T06:16:19Z._
